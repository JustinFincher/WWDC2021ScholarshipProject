        ...
        ScrollView(.vertical, showsIndicators: true, content: {
            VStack(alignment: .leading, spacing: 8, content: {
                Text("Skeleton Positioning")
                    .font(.subheadline)
                Text("You may find that the captured skeleton is a bit off from the real position your buddy is standing at. Drag the sliders below to manually align it until you see the skeleton prefectly embeded in the scanned point clouds. Then press next.")
                    .font(.caption)
                ...
                Button(action: {
                    OperationManager.shared.goTo(mode: .removeBgAndRig) { }
                }, label: {
